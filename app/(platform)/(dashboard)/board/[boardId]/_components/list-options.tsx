  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button className="h-full px-2 pt-1.5 pb-2.5" variant="ghost">
      ...
      <PopoverContent className="px-0 pt-3 pb-0" side="bottom" align="start">
        ...
        <form action={onDelete}>
          ...
          <input hidden name="boardId" id="boardId" value={data.boardId} />
          <FormSubmit
            className="rounded-none w-full h-auto p-3 px-5 justify-start font-normal text-sm hover:bg-red-500 hover:text-white rounded-b-md "
            variant="ghost"
          >
            Delete list...
          </FormSubmit>
